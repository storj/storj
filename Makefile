...
.PHONY: diagrams
diagrams:
	archview -trim-prefix storj.io/storj/satellite/ -out satellite.graphml ./satellite/...
	archview -trim-prefix storj.io/storj/storagenode/ -out storage-node.graphml ./storagenode/...
