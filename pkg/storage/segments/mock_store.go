...
func (m *MockStore) Delete(arg0 context.Context, arg1 Path) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Get(arg0 context.Context, arg1 Path) (ranger.Ranger, Meta, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) List(arg0 context.Context, arg1 Path, arg2, arg3 string, arg4 bool, arg5 int, arg6 uint32) ([]ListItem, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Meta(arg0 context.Context, arg1 Path) (Meta, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Put(arg0 context.Context, arg1 io.Reader, arg2 time.Time, arg3 func() (Path, []byte, error)) (Meta, error) {
	m.ctrl.T.Helper()
