...
func TestServiceList(t *testing.T) {
	...
	for i, tt := range []struct {
		...
		{"", "", "", true, 0, MetaNone, nil, keys, keys, false, nil, ""},
		{"", "", "", true, 0, MetaAll, nil, keys, keys, false, nil, ""},
		{"", "", "", true, 0, MetaNone, []byte("wrong key"), keys, keys, false,
			nil, grpc.Errorf(codes.Unauthenticated, "Invalid API credential").Error()},
		{"", "", "", true, 0, MetaNone, nil, keys, keys, false,
			errors.New("list error"), status.Errorf(codes.Internal, "list error").Error()},
		{"", "", "", true, 2, MetaNone, nil, keys, keys[:2], true, nil, ""},
		{"", "", "", false, 0, MetaNone, nil, keys, keys[:1], false, nil, ""},
		{"music", "", "", false, 0, MetaNone, nil, keys[1:], storage.Keys{keys[1], keys[2], keys[4]}, false, nil, ""},
		{"music", "", "", true, 0, MetaNone, nil, keys[1:], keys[1:5], false, nil, ""},
		{"music", "song1.mp3", "", true, 0, MetaNone, nil, keys, keys[2:5], false, nil, ""},
		{"music", "song1.mp3", "album/song3.mp3", true, 0, MetaNone, nil, keys, keys[2:3], false, nil, ""},
		{"music", "", "song4.mp3", true, 0, MetaNone, nil, keys, keys[1:4], false, nil, ""},
		{"music", "", "song4.mp3", true, 1, MetaNone, nil, keys, keys[3:4], true, nil, ""},
		{"music", "", "song4.mp3", false, 0, MetaNone, nil, keys, keys[1:3], false, nil, ""},
		{"music", "song2.mp3", "song4.mp3", true, 0, MetaNone, nil, keys, keys[3:4], false, nil, ""},
	} {
		errTag := fmt.Sprintf("Test case #%d", i)
