...
type Client interface {
	...
	PayerBandwidthAllocation(context.Context, pb.BandwidthAction, int64) (*pb.OrderLimit, error)
...
func (pdb *PointerDB) PayerBandwidthAllocation(ctx context.Context, action pb.BandwidthAction, maxSize int64) (resp *pb.OrderLimit, err error) {
	defer mon.Task()(&ctx)(&err)
