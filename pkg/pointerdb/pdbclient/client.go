...
type Client interface {
	...
	Get(ctx context.Context, path storj.Path) (*pb.Pointer, []*pb.Node, *pb.FundsOrder, error)
	List(ctx context.Context, prefix, startAfter, endBefore storj.Path, recursive bool, limit int, metaFlags uint32) (items []ListItem, more bool, err error)
	Delete(ctx context.Context, path storj.Path) error

	PayerBandwidthAllocation(context.Context, pb.BandwidthAction) (*pb.FundsOrder, error)
...
func (pdb *PointerDB) Get(ctx context.Context, path storj.Path) (pointer *pb.Pointer, nodes []*pb.Node, pba *pb.FundsOrder, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (pdb *PointerDB) PayerBandwidthAllocation(ctx context.Context, action pb.BandwidthAction) (resp *pb.FundsOrder, err error) {
	defer mon.Task()(&ctx)(&err)
