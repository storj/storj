...
type Config struct {
	...
	MaxExcessRateOptimalThreshold float64       `help:"ratio applied to the optimal threshold to calculate the excess of maximum number of repaired pieces to upload" default:"0.05"`
}
