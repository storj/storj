...
// DefaultMaxListeners is the maximum allowed listeners for an event.
const DefaultMaxListeners = 10

// ErrNoneFunction is thrown when an invalid type is provided as a listener function
var ErrNoneFunction = errors.New("value for listener is not of type `Func`")
