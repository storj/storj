...
func TestUploadDownload(t *testing.T) {
	...
	testidentity.IdentityVersionsTest(t, func(t *testing.T, version storj.IDVersion, gatewayIdent *identity.FullIdentity) {
		...
		go func() {
			...
			err := runGateway(ctx, gwCfg, uplinkCfg, zaptest.NewLogger(t), gatewayIdent)
			if err != nil {
				t.Log(err)
			}
		}()
