...
func (c Config) Run(ctx context.Context, server *provider.Provider) (err error) {
	...
	pointers, err := satellite.NewSatelliteClient(identity, c.SatelliteAddr, c.APIKey)
	if err != nil {
		return err
	}
...
func NewService(ctx context.Context, statDBPort string, interval time.Duration, maxRetries int, pointers *satellite.SatelliteClient, transport transport.Client, overlay overlay.Client,
