	...
	for i := 0; i < t.NumField(); i++ {
		...
		default:
			...
			case reflect.Int8:
				setter = setInt8Value
			case reflect.Int16:
				setter = setInt16Value
			case reflect.Int32:
				setter = setInt32Value
			case reflect.Int64:
				setter = setInt64Value
			case reflect.Uint:
				setter = setUintValue
			case reflect.Uint8:
				setter = setUint8Value
			case reflect.Uint16:
				setter = setUint16Value
			case reflect.Uint32:
				setter = setUint32Value
			case reflect.Uint64:
				setter = setUint64Value
			case reflect.Float32:
				setter = setFloat32Value
...
func setIntValue(v reflect.Value, s string) error {
...
func setInt8Value(v reflect.Value, s string) error {
...
func setInt16Value(v reflect.Value, s string) error {
...
func setInt32Value(v reflect.Value, s string) error {
...
func setUintValue(v reflect.Value, s string) error {
...
func setUint8Value(v reflect.Value, s string) error {
...
func setUint16Value(v reflect.Value, s string) error {
...
func setUint32Value(v reflect.Value, s string) error {
...
func setFloat32Value(v reflect.Value, s string) error {
