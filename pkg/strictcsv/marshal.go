	...
	for i := 0; i < t.NumField(); i++ {
		...
		default:
			...
			case reflect.Uint:
				getter = getUintValue
			case reflect.Uint8:
				getter = getUint8Value
			case reflect.Uint16:
				getter = getUint16Value
			case reflect.Uint32:
				getter = getUint32Value
			case reflect.Uint64:
				getter = getUint64Value
			case reflect.Float32:
				getter = getFloat32Value
...
func getIntValue(v reflect.Value) (string, error) {
	return strconv.FormatInt(int64(v.Convert(intType).Interface().(int)), 10), nil
}

func getInt8Value(v reflect.Value) (string, error) {
	return strconv.FormatInt(int64(v.Convert(int8Type).Interface().(int8)), 10), nil
}

func getInt16Value(v reflect.Value) (string, error) {
	return strconv.FormatInt(int64(v.Convert(int16Type).Interface().(int16)), 10), nil
}

func getInt32Value(v reflect.Value) (string, error) {
	return strconv.FormatInt(int64(v.Convert(int32Type).Interface().(int32)), 10), nil
}
...
func getUintValue(v reflect.Value) (string, error) {
	return strconv.FormatUint(uint64(v.Convert(uintType).Interface().(uint)), 10), nil
}

func getUint8Value(v reflect.Value) (string, error) {
	return strconv.FormatUint(uint64(v.Convert(uint8Type).Interface().(uint8)), 10), nil
}

func getUint16Value(v reflect.Value) (string, error) {
	return strconv.FormatUint(uint64(v.Convert(uint16Type).Interface().(uint16)), 10), nil
}

func getUint32Value(v reflect.Value) (string, error) {
	return strconv.FormatUint(uint64(v.Convert(uint32Type).Interface().(uint32)), 10), nil
}
...
func getFloat32Value(v reflect.Value) (string, error) {
	return strconv.FormatFloat(float64(v.Convert(float32Type).Interface().(float32)), 'f', 6, 32), nil
}
