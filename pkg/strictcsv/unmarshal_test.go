...
func TestUnmarshalFailsToUnmarshalField(t *testing.T) {
	for _, s := range []interface{}{
		...
		&struct {
			Field int8 `csv:"field"`
		}{},
		&struct {
			Field int16 `csv:"field"`
		}{},
		&struct {
			Field int32 `csv:"field"`
		}{},
		&struct {
			Field int64 `csv:"field"`
		}{},
		&struct {
			Field uint `csv:"field"`
		}{},
		&struct {
			Field uint8 `csv:"field"`
		}{},
		&struct {
			Field uint16 `csv:"field"`
		}{},
		&struct {
			Field uint32 `csv:"field"`
		}{},
		&struct {
			Field uint64 `csv:"field"`
		}{},
		&struct {
			Field float32 `csv:"field"`
		}{},
		&struct {
