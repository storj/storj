...
// Create a db entry for the provided storjnode
...
// Get a storjnode's stats from the db
...
// Update a single storjnode's stats in the db
...
// UpdateBatch for updating  multiple storjnodes' stats in the db
