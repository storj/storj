...
// Node is info for a updating a single storjnode, used in the Update rpc calls
type Node struct {
...
// NodeStats is info about a single storjnode stored in the stats db
...
type StatDBClient interface {
	// Create a db entry for the provided storjnode ID
	Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error)
	// Get uses a storjnode ID to get that storjnode's stats
	Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error)
	// Update updates storjnode stats for a single storjnode
	Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error)
	// UpdateBatch updates storjnode stats for multiple storjnodes at a time
