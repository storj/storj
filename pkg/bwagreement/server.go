...
type DB interface {
	...
	CreateAgreement(context.Context, *pb.FileOrder) error
...
func (s *Server) BandwidthAgreements(ctx context.Context, rba *pb.FileOrder) (reply *pb.AgreementsSummary, err error) {
