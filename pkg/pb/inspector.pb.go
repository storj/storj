...
type CreateInvoicesRequest struct {
	BaseDate             *timestamp.Timestamp `protobuf:"bytes,1,opt,name=base_date,json=baseDate,proto3" json:"base_date,omitempty"`
...
func (m *CreateInvoicesRequest) GetBaseDate() *timestamp.Timestamp {
	if m != nil {
		return m.BaseDate
	}
	return nil
...
func (*GetBucketListResponse_Bucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07d9034b2dd9d26, []int{12, 0}
}
...
func (*ObjectHealthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07d9034b2dd9d26, []int{36}
}
...
func (*ObjectHealthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07d9034b2dd9d26, []int{37}
}
...
func init() {
	proto.RegisterType((*CreateInvoicesRequest)(nil), "inspector.CreateInvoicesRequest")
	proto.RegisterType((*CreateInvoicesResponse)(nil), "inspector.CreateInvoicesResponse")
...
var fileDescriptor_a07d9034b2dd9d26 = []byte{
	...
	,
}
...
// PaymentInspectorClient is the client API for PaymentInspector service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type PaymentInspectorClient interface {
	// create invoices for all projects, if selectedProjectIDs length > 0
	// creates invoices only for those projects in the list
	CreateInvoices(ctx context.Context, in *CreateInvoicesRequest, opts ...grpc.CallOption) (*CreateInvoicesResponse, error)
}

type paymentInspectorClient struct {
	cc *grpc.ClientConn
}

func NewPaymentInspectorClient(cc *grpc.ClientConn) PaymentInspectorClient {
	return &paymentInspectorClient{cc}
}

func (c *paymentInspectorClient) CreateInvoices(ctx context.Context, in *CreateInvoicesRequest, opts ...grpc.CallOption) (*CreateInvoicesResponse, error) {
	out := new(CreateInvoicesResponse)
	err := c.cc.Invoke(ctx, "/inspector.PaymentInspector/CreateInvoices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// PaymentInspectorServer is the server API for PaymentInspector service.
type PaymentInspectorServer interface {
	// create invoices for all projects, if selectedProjectIDs length > 0
	// creates invoices only for those projects in the list
	CreateInvoices(context.Context, *CreateInvoicesRequest) (*CreateInvoicesResponse, error)
}

func RegisterPaymentInspectorServer(s *grpc.Server, srv PaymentInspectorServer) {
	s.RegisterService(&_PaymentInspector_serviceDesc, srv)
}

func _PaymentInspector_CreateInvoices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateInvoicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentInspectorServer).CreateInvoices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspector.PaymentInspector/CreateInvoices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentInspectorServer).CreateInvoices(ctx, req.(*CreateInvoicesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _PaymentInspector_serviceDesc = grpc.ServiceDesc{
	ServiceName: "inspector.PaymentInspector",
	HandlerType: (*PaymentInspectorServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateInvoices",
			Handler:    _PaymentInspector_CreateInvoices_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "inspector.proto",
