...
func (NodeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_node_4092bd8d98e49a0d, []int{0}
}
...
func (NodeTransport) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_node_4092bd8d98e49a0d, []int{1}
}
...
func (*NodeAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_4092bd8d98e49a0d, []int{2}
}
...
func (*NodeStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_4092bd8d98e49a0d, []int{3}
}
...
func (*NodeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_4092bd8d98e49a0d, []int{4}
}
...
func init() { proto.RegisterFile("node.proto", fileDescriptor_node_4092bd8d98e49a0d) }

var fileDescriptor_node_4092bd8d98e49a0d = []byte{
