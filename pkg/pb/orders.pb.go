...
func (PieceAction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_orders_160585f6dfe4ff84, []int{0}
}
...
func (SettlementResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_orders_160585f6dfe4ff84, []int{4, 0}
}
...
func (*Order2) Descriptor() ([]byte, []int) {
	return fileDescriptor_orders_160585f6dfe4ff84, []int{1}
}
...
func (*PieceHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_orders_160585f6dfe4ff84, []int{2}
}
...
func (*SettlementRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_orders_160585f6dfe4ff84, []int{3}
}
...
func (*SettlementResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_orders_160585f6dfe4ff84, []int{4}
}
...
func init() { proto.RegisterFile("orders.proto", fileDescriptor_orders_160585f6dfe4ff84) }

var fileDescriptor_orders_160585f6dfe4ff84 = []byte{
