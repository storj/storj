...
type PieceUploadRequest struct {
	...
	// order for uploading
	Order *Order2                   `protobuf:"bytes,2,opt,name=order" json:"order,omitempty"`
	Chunk *PieceUploadRequest_Chunk `protobuf:"bytes,3,opt,name=chunk" json:"chunk,omitempty"`
	// final message
	Done                 *PieceHash `protobuf:"bytes,4,opt,name=done" json:"done,omitempty"`
...
func (*PieceUploadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{0}
}
...
func (*PieceUploadRequest_Chunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{0, 0}
}
...
type PieceUploadResponse struct {
	Done                 *PieceHash `protobuf:"bytes,1,opt,name=done" json:"done,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*PieceUploadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{1}
}
...
type PieceDownloadRequest struct {
	...
	Chunk                *PieceDownloadRequest_Chunk `protobuf:"bytes,3,opt,name=chunk" json:"chunk,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (*PieceDownloadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{2}
}
...
func (*PieceDownloadRequest_Chunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{2, 0}
}
...
type PieceDownloadResponse struct {
	Chunk                *PieceDownloadResponse_Chunk `protobuf:"bytes,1,opt,name=chunk" json:"chunk,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
}
...
func (*PieceDownloadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{3}
}
...
func (*PieceDownloadResponse_Chunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{3, 0}
}
...
func (*PieceDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{4}
}
...
func (*PieceDeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore2_4f7e43917f6baad9, []int{5}
}
...
func init() { proto.RegisterFile("piecestore2.proto", fileDescriptor_piecestore2_4f7e43917f6baad9) }

var fileDescriptor_piecestore2_4f7e43917f6baad9 = []byte{
