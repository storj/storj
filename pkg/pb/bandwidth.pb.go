...
func (AgreementsSummary_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_5df12c114d68edff, []int{0, 0}
}
...
func (*AgreementsSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_5df12c114d68edff, []int{0}
}
...
func (*BandwidthSettlementRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_5df12c114d68edff, []int{1}
}
...
func (*BandwidthSettlementResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_5df12c114d68edff, []int{2}
}
...
func init() { proto.RegisterFile("bandwidth.proto", fileDescriptor_bandwidth_5df12c114d68edff) }

var fileDescriptor_bandwidth_5df12c114d68edff = []byte{
