...
func (AgreementsSummary_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_e9265d4c03193947, []int{1, 0}
}
...
func (*BandWidthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_e9265d4c03193947, []int{0}
}
...
func (m *BandWidthRequest) GetOrder() Order {
	if m != nil {
		return m.Order
	}
	return Order{}
...
func (*AgreementsSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_e9265d4c03193947, []int{1}
}
...
func init() { proto.RegisterFile("bandwidth.proto", fileDescriptor_bandwidth_e9265d4c03193947) }

var fileDescriptor_bandwidth_e9265d4c03193947 = []byte{
	...
	0xbc, 0x27, 0xee, 0xc9, 0x33, 0xfc, 0xba, 0x27, 0xcf, 0xea, 0x0f, 0xd2, 0x15, 0x04, 0xd1, 0xac,
	...
	0x00, 0xff, 0xff, 0x4f, 0x9d, 0x22, 0xfb, 0x7f, 0x01, 0x00, 0x00,
}
