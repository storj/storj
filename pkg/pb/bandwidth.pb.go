...
func (AgreementsSummary_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_d28b10b8b40702d0, []int{0, 0}
}
...
func (*AgreementsSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_d28b10b8b40702d0, []int{0}
}
...
type BandwidthSettlementRequest struct {
	Allocation           *RenterBandwidthAllocation `protobuf:"bytes,1,opt,name=allocation" json:"allocation,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (*BandwidthSettlementRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_d28b10b8b40702d0, []int{1}
}
...
func (dst *BandwidthSettlementRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BandwidthSettlementRequest.Merge(dst, src)
}
...
func (*BandwidthSettlementResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bandwidth_d28b10b8b40702d0, []int{2}
}
...
func (dst *BandwidthSettlementResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BandwidthSettlementResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("bandwidth.proto", fileDescriptor_bandwidth_d28b10b8b40702d0) }

var fileDescriptor_bandwidth_d28b10b8b40702d0 = []byte{
