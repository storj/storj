...
func (*Voucher) Descriptor() ([]byte, []int) {
	return fileDescriptor_vouchers_a0642c1696421a0e, []int{0}
}
...
func (*VoucherRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_vouchers_a0642c1696421a0e, []int{1}
}
...
func (dst *VoucherRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoucherRequest.Merge(dst, src)
}
...
func init() { proto.RegisterFile("vouchers.proto", fileDescriptor_vouchers_a0642c1696421a0e) }

var fileDescriptor_vouchers_a0642c1696421a0e = []byte{
