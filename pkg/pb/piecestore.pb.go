...
func (PayerBandwidthAllocation_Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{0, 0}
}
...
func (*PayerBandwidthAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{0}
}
...
func (*RenterBandwidthAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{1}
}
...
func (*RenterBandwidthAllocation_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{1, 0}
}
...
func (*PieceStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{2}
}
...
func (*PieceStore_PieceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{2, 0}
}
...
func (*PieceId) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{3}
}
...
func (*PieceSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{4}
}
...
func (*PieceRetrieval) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{5}
}
...
func (*PieceRetrieval_PieceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{5, 0}
}
...
func (*PieceRetrievalStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{6}
}
...
func (*PieceDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{7}
}
...
func (*PieceDeleteSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{8}
}
...
func (*PieceStoreSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{9}
}
...
func (*StatsReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{10}
}
...
func (*StatSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{11}
}
...
func (*SignedMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{12}
}
...
func (*DashboardReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{13}
}
...
type DashboardStream struct {
	NodeId               *Node        `protobuf:"bytes,1,opt,name=node_id,json=nodeId" json:"node_id,omitempty"`
...
func (m *DashboardStream) Reset()         { *m = DashboardStream{} }
func (m *DashboardStream) String() string { return proto.CompactTextString(m) }
func (*DashboardStream) ProtoMessage()    {}
func (*DashboardStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_b1ab23ebfbb4cc2b, []int{14}
}
func (m *DashboardStream) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DashboardStream.Unmarshal(m, b)
}
func (m *DashboardStream) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DashboardStream.Marshal(b, m, deterministic)
}
func (dst *DashboardStream) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DashboardStream.Merge(dst, src)
}
func (m *DashboardStream) XXX_Size() int {
	return xxx_messageInfo_DashboardStream.Size(m)
}
func (m *DashboardStream) XXX_DiscardUnknown() {
	xxx_messageInfo_DashboardStream.DiscardUnknown(m)
}

var xxx_messageInfo_DashboardStream proto.InternalMessageInfo

func (m *DashboardStream) GetNodeId() *Node {
	if m != nil {
		return m.NodeId
	}
	return nil
...
func (m *DashboardStream) GetNodeConnections() int64 {
	if m != nil {
...
func (m *DashboardStream) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *DashboardStream) GetStats() *StatSummary {
	if m != nil {
		return m.Stats
	}
	return nil
...
func (m *DashboardStream) GetConnection() bool {
	if m != nil {
		return m.Connection
	}
	return false
...
func (m *DashboardStream) GetUptime() int64 {
	if m != nil {
		return m.Uptime
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*DashboardStream)(nil), "piecestoreroutes.DashboardStream")
...
type PieceStoreRoutesClient interface {
	...
	Dashboard(ctx context.Context, opts ...grpc.CallOption) (PieceStoreRoutes_DashboardClient, error)
}
...
func (c *pieceStoreRoutesClient) Dashboard(ctx context.Context, opts ...grpc.CallOption) (PieceStoreRoutes_DashboardClient, error) {
...
type PieceStoreRoutes_DashboardClient interface {
	Send(*DashboardReq) error
	Recv() (*DashboardStream, error)
	grpc.ClientStream
}
...
func (x *pieceStoreRoutesDashboardClient) Send(m *DashboardReq) error {
	return x.ClientStream.SendMsg(m)
}

func (x *pieceStoreRoutesDashboardClient) Recv() (*DashboardStream, error) {
	m := new(DashboardStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type PieceStoreRoutesServer interface {
	...
	Dashboard(PieceStoreRoutes_DashboardServer) error
}
...
func _PieceStoreRoutes_Dashboard_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PieceStoreRoutesServer).Dashboard(&pieceStoreRoutesDashboardServer{stream})
}

type PieceStoreRoutes_DashboardServer interface {
	Send(*DashboardStream) error
	Recv() (*DashboardReq, error)
	grpc.ServerStream
}
...
func (x *pieceStoreRoutesDashboardServer) Send(m *DashboardStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *pieceStoreRoutesDashboardServer) Recv() (*DashboardReq, error) {
	m := new(DashboardReq)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("piecestore.proto", fileDescriptor_piecestore_b1ab23ebfbb4cc2b) }

var fileDescriptor_piecestore_b1ab23ebfbb4cc2b = []byte{
	...
	,
}
