...
func (BandwidthAction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{0}
}
...
type PayerBandwidthAllocation struct {
	...
	SignedMessage        `protobuf:"bytes,8,opt,name=signed_data,json=signedData,proto3,embedded=signed_data" json:"signed_data"`
...
type RenterBandwidthAllocation struct {
	OrderLimit           OrderLimit `protobuf:"bytes,1,opt,name=order_limit,json=orderLimit,proto3,casttype=OrderLimit" json:"order_limit"`
	...
	SignedMessage        `protobuf:"bytes,4,opt,name=signed_data,json=signedData,proto3,embedded=signed_data" json:"signed_data"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RenterBandwidthAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{1}
}
...
func (m *RenterBandwidthAllocation) GetOrderLimit() OrderLimit {
	if m != nil {
		return m.OrderLimit
	}
	return OrderLimit{}
...
type PieceStore struct {
	Order                Order                 `protobuf:"bytes,1,opt,name=order,proto3,casttype=Order" json:"order"`
	PieceData            *PieceStore_PieceData `protobuf:"bytes,2,opt,name=piece_data,json=pieceData,proto3" json:"piece_data,omitempty"`
	SignedHash           SignedHash            `protobuf:"bytes,4,opt,name=signed_hash,json=signedHash,proto3,customtype=SignedHash" json:"signed_hash"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*PieceStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{2}
}
...
func (m *PieceStore) GetOrder() Order {
	if m != nil {
		return m.Order
	}
	return Order{}
...
func (*PieceStore_PieceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{2, 0}
}
...
func (*PieceId) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{3}
}
...
func (*PieceSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{4}
}
...
func (*PieceRetrieval) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{5}
}
...
func (m *PieceRetrieval) GetOrder() Order {
	if m != nil {
		return m.Order
	}
	return Order{}
...
func (*PieceRetrieval_PieceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{5, 0}
}
...
func (*PieceRetrievalStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{6}
}
...
func (*PieceDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{7}
}
...
func (*PieceDeleteSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{8}
}
...
type PieceStoreSummary struct {
	...
	SignedHash           SignedHash `protobuf:"bytes,3,opt,name=signed_hash,json=signedHash,proto3,customtype=SignedHash" json:"signed_hash"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*PieceStoreSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{9}
}
...
func (*StatsReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{10}
}
...
func (*StatSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{11}
}
...
type SignedMessage struct {
	...
	Certs                [][]byte `protobuf:"bytes,3,rep,name=certs,proto3" json:"certs,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*SignedMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{12}
}
...
func (m *SignedMessage) GetCerts() [][]byte {
	if m != nil {
		return m.Certs
	}
	return nil
...
func (*DashboardReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{13}
}
...
func (*DashboardStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{14}
}
...
// Hash is always serialized as SignedMessage
type Hash struct {
	Hash                 []byte `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`
	SignedMessage        `protobuf:"bytes,2,opt,name=signed_data,json=signedData,proto3,embedded=signed_data" json:"signed_data"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*Hash) Descriptor() ([]byte, []int) {
	return fileDescriptor_piecestore_2e4ed61853d27283, []int{15}
}
...
func init() {
	...
	proto.RegisterType((*Hash)(nil), "piecestoreroutes.Hash")
...
func init() { proto.RegisterFile("piecestore.proto", fileDescriptor_piecestore_2e4ed61853d27283) }

var fileDescriptor_piecestore_2e4ed61853d27283 = []byte{
	// 1187 bytes of a gzipped FileDescriptorProto
	,
}
