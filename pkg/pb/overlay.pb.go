...
type QueryRequest struct {
	...
	QueryTimeout         *duration.Duration `protobuf:"bytes,5,opt,name=query_timeout,json=queryTimeout,proto3" json:"query_timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *QueryRequest) GetQueryTimeout() *duration.Duration {
	if m != nil {
...
var fileDescriptor_61fc82527fbe24ad = []byte{
	...
	,
}
