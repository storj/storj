...
func (Restriction_Operator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{6, 0}
}
...
func (Restriction_Operand) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{6, 1}
}
...
func (*QueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{0}
}
...
func (*QueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{1}
}
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{2}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{3}
}
...
func (*InfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{4}
}
...
func (*InfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{5}
}
...
func (*Restriction) Descriptor() ([]byte, []int) {
	return fileDescriptor_overlay_05d17f838ac4adea, []int{6}
}
...
func init() { proto.RegisterFile("overlay.proto", fileDescriptor_overlay_05d17f838ac4adea) }

var fileDescriptor_overlay_05d17f838ac4adea = []byte{
