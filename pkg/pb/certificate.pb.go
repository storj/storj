...
func init() {
	proto.RegisterType((*SigningRequest)(nil), "v0_1.SigningRequest")
	proto.RegisterType((*SigningResponse)(nil), "v0_1.SigningResponse")
}
...
var fileDescriptor_c0d34c34dd33be4b = []byte{
	...
	0xc9, 0x4c, 0xcb, 0x4c, 0x4e, 0x2c, 0x49, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x29,
	0x33, 0x88, 0x37, 0x94, 0xe2, 0x4a, 0xcf, 0x4f, 0xcf, 0x87, 0x88, 0x28, 0xf9, 0x72, 0xf1, 0x05,
	...
	0x4f, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x30, 0x2f, 0xb2, 0x8e, 0xf0, 0x00, 0x00, 0x00,
}
...
func (c *certificatesClient) Sign(ctx context.Context, in *SigningRequest, opts ...grpc.CallOption) (*SigningResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v0_1.Certificates/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Certificates_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v0_1.Certificates/Sign",
	}
