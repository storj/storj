...
func (*SigningRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_0451c3db6dcf0212, []int{0}
}
...
func (*SigningResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_0451c3db6dcf0212, []int{1}
}
...
func init() {
	proto.RegisterType((*SigningRequest)(nil), "storjv3_0_0.SigningRequest")
	proto.RegisterType((*SigningResponse)(nil), "storjv3_0_0.SigningResponse")
}
...
func (c *certificatesClient) Sign(ctx context.Context, in *SigningRequest, opts ...grpc.CallOption) (*SigningResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/storjv3_0_0.Certificates/Sign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Certificates_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/storjv3_0_0.Certificates/Sign",
	}
...
var _Certificates_serviceDesc = grpc.ServiceDesc{
	ServiceName: "storjv3_0_0.Certificates",
...
func init() { proto.RegisterFile("certificate.proto", fileDescriptor_certificate_0451c3db6dcf0212) }

var fileDescriptor_certificate_0451c3db6dcf0212 = []byte{
	// 199 bytes of a gzipped FileDescriptorProto
	,
}
