...
func (*SigningRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_bc436706e24d89b4, []int{0}
}
...
func (*SigningResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_bc436706e24d89b4, []int{1}
}
...
func init() { proto.RegisterFile("certificate.proto", fileDescriptor_certificate_bc436706e24d89b4) }

var fileDescriptor_certificate_bc436706e24d89b4 = []byte{
