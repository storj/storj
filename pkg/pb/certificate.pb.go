...
func (*SigningRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_a6991cd765b74e88, []int{0}
}
...
func (*SigningResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_certificate_a6991cd765b74e88, []int{1}
}
...
type CertificatesClient interface {
	Signing(ctx context.Context, in *SigningRequest, opts ...grpc.CallOption) (*SigningResponse, error)
}
...
func (c *certificatesClient) Signing(ctx context.Context, in *SigningRequest, opts ...grpc.CallOption) (*SigningResponse, error) {
	out := new(SigningResponse)
	err := c.cc.Invoke(ctx, "/node.Certificates/Signing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CertificatesServer interface {
	Signing(context.Context, *SigningRequest) (*SigningResponse, error)
}
...
func _Certificates_Signing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SigningRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CertificatesServer).Signing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/node.Certificates/Signing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CertificatesServer).Signing(ctx, req.(*SigningRequest))
	}
...
var _Certificates_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Signing",
			Handler:    _Certificates_Signing_Handler,
		},
	},
...
func init() { proto.RegisterFile("certificate.proto", fileDescriptor_certificate_a6991cd765b74e88) }

var fileDescriptor_certificate_a6991cd765b74e88 = []byte{
	...
	0x89, 0x25, 0xa5, 0x45, 0xa9, 0x50, 0xb5, 0x08, 0x01, 0x23, 0x37, 0x2e, 0x1e, 0x67, 0x84, 0xed,
	0xc5, 0x42, 0x66, 0x5c, 0xec, 0x50, 0x03, 0x84, 0x44, 0xf4, 0x40, 0x8e, 0xd0, 0x43, 0xb5, 0x55,
	0x4a, 0x14, 0x4d, 0x14, 0x62, 0x8b, 0x13, 0x4b, 0x14, 0x53, 0x41, 0x52, 0x12, 0x1b, 0xd8, 0xad,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xab, 0x5d, 0x19, 0x30, 0xd2, 0x00, 0x00, 0x00,
}
