...
func TestAddNode(t *testing.T) {
	...
	cases := []struct {
		...
		{testID: "PO: add node to unfilled kbucket",
			node:    mockNode("PO"),
			added:   true,
			kadIDs:  [][]byte{[]byte{255, 255}},
			nodeIDs: [][]string{[]string{"OO", "PO"}},
		},
		{testID: "NO: add node to full kbucket and split",
			node:    mockNode("NO"),
			added:   true,
			kadIDs:  [][]byte{[]byte{255, 255}},
			nodeIDs: [][]string{[]string{"NO", "OO", "PO"}},
		},
		{testID: "MO",
			node:    mockNode("MO"),
			added:   true,
			kadIDs:  [][]byte{[]byte{255, 255}},
			nodeIDs: [][]string{[]string{"MO", "NO", "OO", "PO"}},
		},
		{testID: "LO",
			node:    mockNode("LO"),
			added:   true,
			kadIDs:  [][]byte{[]byte{255, 255}},
			nodeIDs: [][]string{[]string{"LO", "MO", "NO", "OO", "PO"}},
		},
		{testID: "QO",
			node:    mockNode("QO"),
			added:   true,
			kadIDs:  [][]byte{[]byte{255, 255}},
			nodeIDs: [][]string{[]string{"LO", "MO", "NO", "OO", "PO", "QO"}},
		},
		...
		{testID: ":O",
			...
			added:  true,
			kadIDs: [][]byte{[]byte{63, 255}, []byte{79, 255}, []byte{95, 255}, []byte{127, 255}, []byte{255, 255}},
			nodeIDs: [][]string{[]string{":O", ";O", "=O", ">O", "?O"},
				[]string{"LO", "MO", "NO", "OO"},
				[]string{"PO", "QO", "SO"},
				[]string{},
				[]string{},
		...
		{testID: "9O",
			...
			added:  true,
			kadIDs: [][]byte{[]byte{63, 255}, []byte{79, 255}, []byte{95, 255}, []byte{127, 255}, []byte{255, 255}},
			nodeIDs: [][]string{[]string{"9O", ":O", ";O", "=O", ">O", "?O"},
				[]string{"LO", "MO", "NO", "OO"},
				[]string{"PO", "QO", "SO"},
				[]string{},
				[]string{},
