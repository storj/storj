...
func (dialer *Dialer) Lookup(ctx context.Context, self *pb.Node, ask pb.Node, find storj.NodeID, rtLimit, acLimit int) (_, _ []*pb.Node, err error) {
	...
	return resp.Vetted, resp.Unvetted, nil
}
