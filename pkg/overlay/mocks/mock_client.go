...
func (m *MockClient) Choose(ctx context.Context, op x.Options) ([]storj.Node, error) {
...
func (m *MockClient) Lookup(ctx context.Context, nodeID storj.NodeID) (storj.Node, error) {
...
func (m *MockClient) BulkLookup(ctx context.Context, nodeIDs storj.NodeIDList) ([]storj.Node, error) {
