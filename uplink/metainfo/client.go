...
type Client interface {
	CreateSegment(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64, redundancy *pb.RedundancyScheme, maxEncryptedSegmentSize int64, expiration time.Time) ([]*pb.AddressedOrderLimit, storj.PieceID, error)
	CommitSegment(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64, pointer *pb.Pointer, originalLimits []*pb.OrderLimit2) (*pb.Pointer, error)
...
func (metainfo *Metainfo) CreateSegment(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64, redundancy *pb.RedundancyScheme, maxEncryptedSegmentSize int64, expiration time.Time) (limits []*pb.AddressedOrderLimit, rootPieceID storj.PieceID, err error) {
...
func (metainfo *Metainfo) CommitSegment(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64, pointer *pb.Pointer, originalLimits []*pb.OrderLimit2) (savedPointer *pb.Pointer, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (metainfo *Metainfo) SegmentInfo(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64) (pointer *pb.Pointer, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (metainfo *Metainfo) ReadSegment(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64) (pointer *pb.Pointer, limits []*pb.AddressedOrderLimit, err error) {
	defer mon.Task()(&ctx)(&err)
...
func (metainfo *Metainfo) DeleteSegment(ctx context.Context, bucket string, path paths.Encrypted, segmentIndex int64) (limits []*pb.AddressedOrderLimit, err error) {
	defer mon.Task()(&ctx)(&err)
