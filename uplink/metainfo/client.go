...
func (params *CreateBucketParams) toRequest(apiKey []byte) *pb.BucketCreateRequest {
...
func (params *CreateBucketParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_BucketCreate{
			BucketCreate: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) CreateBucket(ctx context.Context, params CreateBucketParams) (respBucket storj.Bucket, err error) {
	...
	response, err := client.client.CreateBucket(ctx, params.toRequest(client.apiKey))
	if err != nil {
...
func (params *GetBucketParams) toRequest(apiKey []byte) *pb.BucketGetRequest {
...
// BatchItem returns single item for batch request
func (params *GetBucketParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_BucketGet{
			BucketGet: params.toRequest(apiKey),
		},
	}
}
...
func (params *DeleteBucketParams) toRequest(apiKey []byte) *pb.BucketDeleteRequest {
...
// BatchItem returns single item for batch request
func (params *DeleteBucketParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_BucketDelete{
			BucketDelete: params.toRequest(apiKey),
		},
	}
}
...
func (params *ListBucketsParams) toRequest(apiKey []byte) *pb.BucketListRequest {
...
// BatchItem returns single item for batch request
func (params *ListBucketsParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_BucketList{
			BucketList: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) ListBuckets(ctx context.Context, params ListBucketsParams) (_ storj.BucketList, err error) {
	...
	resp, err := client.client.ListBuckets(ctx, params.toRequest(client.apiKey))
	if err != nil {
...
func (params *SetBucketAttributionParams) toRequest(apiKey []byte) *pb.BucketSetAttributionRequest {
...
// BatchItem returns single item for batch request
func (params *SetBucketAttributionParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_BucketSetAttribution{
			BucketSetAttribution: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) SetBucketAttribution(ctx context.Context, params SetBucketAttributionParams) (err error) {
	...
	_, err = client.client.SetBucketAttribution(ctx, params.toRequest(client.apiKey))
...
func (params *BeginObjectParams) toRequest(apiKey []byte) *pb.ObjectBeginRequest {
...
// BatchItem returns single item for batch request
func (params *BeginObjectParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_ObjectBegin{
			ObjectBegin: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) BeginObject(ctx context.Context, params BeginObjectParams) (_ storj.StreamID, err error) {
	...
	response, err := client.client.BeginObject(ctx, params.toRequest(client.apiKey))
	if err != nil {
		return nil, Error.Wrap(err)
	}
...
func (params *CommitObjectParams) toRequest(apiKey []byte) *pb.ObjectCommitRequest {
...
// BatchItem returns single item for batch request
func (params *CommitObjectParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_ObjectCommit{
			ObjectCommit: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) CommitObject(ctx context.Context, params CommitObjectParams) (err error) {
	...
	_, err = client.client.CommitObject(ctx, params.toRequest(client.apiKey))
...
func (params *GetObjectParams) toRequest(apiKey []byte) *pb.ObjectGetRequest {
...
// BatchItem returns single item for batch request
func (params *GetObjectParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_ObjectGet{
			ObjectGet: params.toRequest(apiKey),
		},
	}
}
...
func (params *BeginDeleteObjectParams) toRequest(apiKey []byte) *pb.ObjectBeginDeleteRequest {
...
// BatchItem returns single item for batch request
func (params *BeginDeleteObjectParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_ObjectBeginDelete{
			ObjectBeginDelete: params.toRequest(apiKey),
		},
	}
}
...
func (params *FinishDeleteObjectParams) toRequest(apiKey []byte) *pb.ObjectFinishDeleteRequest {
...
// BatchItem returns single item for batch request
func (params *FinishDeleteObjectParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_ObjectFinishDelete{
			ObjectFinishDelete: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) FinishDeleteObject(ctx context.Context, params FinishDeleteObjectParams) (err error) {
	...
	_, err = client.client.FinishDeleteObject(ctx, params.toRequest(client.apiKey))
...
func (params *ListObjectsParams) toRequest(apiKey []byte) *pb.ObjectListRequest {
...
// BatchItem returns single item for batch request
func (params *ListObjectsParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_ObjectList{
			ObjectList: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) ListObjects(ctx context.Context, params ListObjectsParams) (_ []storj.ObjectListItem, more bool, err error) {
	...
	response, err := client.client.ListObjects(ctx, params.toRequest(client.apiKey))
	if err != nil {
...
func (params *BeginSegmentParams) toRequest(apiKey []byte) *pb.SegmentBeginRequest {
...
// BatchItem returns single item for batch request
func (params *BeginSegmentParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentBegin{
			SegmentBegin: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) BeginSegment(ctx context.Context, params BeginSegmentParams) (_ storj.SegmentID, limits []*pb.AddressedOrderLimit, piecePrivateKey storj.PiecePrivateKey, err error) {
	...
	response, err := client.client.BeginSegment(ctx, params.toRequest(client.apiKey))
	if err != nil {
...
func (params *CommitSegmentParams) toRequest(apiKey []byte) *pb.SegmentCommitRequest {
...
// BatchItem returns single item for batch request
func (params *CommitSegmentParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentCommit{
			SegmentCommit: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) CommitSegmentNew(ctx context.Context, params CommitSegmentParams) (err error) {
	...
	_, err = client.client.CommitSegment(ctx, params.toRequest(client.apiKey))
...
func (params *MakeInlineSegmentParams) toRequest(apiKey []byte) *pb.SegmentMakeInlineRequest {
...
// BatchItem returns single item for batch request
func (params *MakeInlineSegmentParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentMakeInline{
			SegmentMakeInline: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) MakeInlineSegment(ctx context.Context, params MakeInlineSegmentParams) (err error) {
	...
	_, err = client.client.MakeInlineSegment(ctx, params.toRequest(client.apiKey))
...
func (params *BeginDeleteSegmentParams) toRequest(apiKey []byte) *pb.SegmentBeginDeleteRequest {
...
// BatchItem returns single item for batch request
func (params *BeginDeleteSegmentParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentBeginDelete{
			SegmentBeginDelete: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) BeginDeleteSegment(ctx context.Context, params BeginDeleteSegmentParams) (_ storj.SegmentID, limits []*pb.AddressedOrderLimit, _ storj.PiecePrivateKey, err error) {
	...
	response, err := client.client.BeginDeleteSegment(ctx, params.toRequest(client.apiKey))
	if err != nil {
		return storj.SegmentID{}, nil, storj.PiecePrivateKey{}, Error.Wrap(err)
	}
...
func (params *FinishDeleteSegmentParams) toRequest(apiKey []byte) *pb.SegmentFinishDeleteRequest {
...
// BatchItem returns single item for batch request
func (params *FinishDeleteSegmentParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentFinishDelete{
			SegmentFinishDelete: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) FinishDeleteSegment(ctx context.Context, params FinishDeleteSegmentParams) (err error) {
	...
	_, err = client.client.FinishDeleteSegment(ctx, params.toRequest(client.apiKey))
...
func (params *DownloadSegmentParams) toRequest(apiKey []byte) *pb.SegmentDownloadRequest {
...
// BatchItem returns single item for batch request
func (params *DownloadSegmentParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentDownload{
			SegmentDownload: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) DownloadSegment(ctx context.Context, params DownloadSegmentParams) (_ storj.SegmentDownloadInfo, _ []*pb.AddressedOrderLimit, err error) {
	...
	response, err := client.client.DownloadSegment(ctx, params.toRequest(client.apiKey))
	if err != nil {
...
func (params *ListSegmentsParams) toRequest(apiKey []byte) *pb.SegmentListRequest {
...
// BatchItem returns single item for batch request
func (params *ListSegmentsParams) BatchItem(apiKey []byte) *pb.BatchRequestItem {
	return &pb.BatchRequestItem{
		Request: &pb.BatchRequestItem_SegmentList{
			SegmentList: params.toRequest(apiKey),
		},
	}
}
...
func (client *Client) ListSegmentsNew(ctx context.Context, params ListSegmentsParams) (_ []storj.SegmentListItem, more bool, err error) {
	...
	response, err := client.client.ListSegments(ctx, params.toRequest(client.apiKey))
	if err != nil {
...
func (client *Client) Batch(ctx context.Context, requests ...BatchItem) (resp []BatchResponse, err error) {
	...
	for i, request := range requests {
		batchItems[i] = request.BatchItem(client.apiKey)
	}
