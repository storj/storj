...
random_bytes_file "5120"    "$SRC_DIR/big-upload-testfile"            # create 5mb file of random bytes (remote)
random_bytes_file "12000"   "$SRC_DIR/multisegment-upload-testfile"   # create 2 x 6mb file of random bytes (remote) 
random_bytes_file "9000"    "$SRC_DIR/diff-size-segments"             # create 9mb file of random bytes (remote)
