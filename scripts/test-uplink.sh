...
random_bytes_file "12288"   "$SRC_DIR/multisegment-upload-testfile"   # create 2 x 6mb file of random bytes (remote) 
random_bytes_file "9216"    "$SRC_DIR/diff-size-segments"             # create 9mb file of random bytes (remote)
