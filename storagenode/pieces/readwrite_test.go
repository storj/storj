...
func BenchmarkReadWrite(b *testing.B) {
	...
	store := pieces.NewStore(zap.NewNop(), pieces.NewFileWalker(zap.NewNop(), blobs, nil, nil), nil, blobs, nil, nil, nil, pieces.DefaultConfig)
...
func readAndWritePiece(t *testing.T, content []byte) {
	...
	store := pieces.NewStore(log, pieces.NewFileWalker(log, blobs, nil, nil), nil, blobs, nil, nil, nil, pieces.DefaultConfig)
