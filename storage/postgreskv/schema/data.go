...
var __2020011301_drop_not_nullDownSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\xe2\xe5\x02\x04\x00\x00\xff\xff\xac\x85\xa2\x14\x02\x00\x00\x00")
...
func _2020011301_drop_not_nullDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "2020011301_drop_not_null.down.sql", size: 2, mode: os.FileMode(438), modTime: time.Unix(1579196645, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
