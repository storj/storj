...
// VersionedClient cointains and managers a transport client, that internally checks if the software version
// is still up to date and refuses outgoing connections in case it is outdated
