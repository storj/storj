...
//func (config *KadPeerConfig) Verify(log *zap.Logger) error {
//	return config.Kademlia.Verify(log)
//}
//
//// KadPeer is the representation of a Bootstrap Node.
//type KadPeer struct {
//	// core dependencies
//	Log      *zap.Logger
...
//func NewKadPeer(log *zap.Logger, full *identity.FullIdentity, db DB, config KadPeerConfig) (*KadPeer, error) {
//	peer := &KadPeer{
//		Log:      log,
//		Identity: full,
//		DB:       db,
...
//func (peer *KadPeer) Run(ctx context.Context) error {
...
//func (peer *KadPeer) ID() storj.NodeID { return peer.Identity.ID }
//
//// Local returns the peer local node info.
//func (peer *KadPeer) Local() pb.Node { return peer.Kademlia.RoutingTable.Local() }
//
//// Addr returns the public address.
//func (peer *KadPeer) Addr() string { return peer.Public.Server.Addr().String() }
