...
func (*BandwidthAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{0}
}
...
func (*PieceStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{1}
}
...
func (*PieceStore_PieceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{1, 0}
}
...
func (*PieceId) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{2}
}
...
func (*PieceSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{3}
}
...
func (*PieceRetrieval) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{4}
}
...
func (*PieceRetrieval_PieceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{4, 0}
}
...
func (*PieceRetrievalStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{5}
}
...
func (*PieceDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{6}
}
...
func (*PieceDeleteSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{7}
}
...
func (*PieceStoreSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_piece_store_3755af9f760d0fea, []int{8}
}
...
func init() { proto.RegisterFile("piece_store.proto", fileDescriptor_piece_store_3755af9f760d0fea) }

var fileDescriptor_piece_store_3755af9f760d0fea = []byte{
	...
	,
}
