...
namespace StorjTests
{
    ...
    {
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "The payout address cannot be empty.")]
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "The payout address must start with a '0x' prefix.")]
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "The payout address must have 40 characters after the '0x' prefix.")]
