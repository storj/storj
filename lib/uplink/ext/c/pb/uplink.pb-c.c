...
static const ProtobufCFieldDescriptor storj__libuplink__bucket_config__field_descriptors[2] =
{
  {
...
static const unsigned storj__libuplink__bucket_config__field_indices_by_name[] = {
  ...
  1,   /* field[1] = path_cipher */
};
static const ProtobufCIntRange storj__libuplink__bucket_config__number_ranges[2 + 1] =
{
  { 1, 0 },
  { 3, 1 },
  { 0, 2 }
...
const ProtobufCMessageDescriptor storj__libuplink__bucket_config__descriptor =
{
  ...
  2,  storj__libuplink__bucket_config__number_ranges,
