...
func runCTests(t *testing.T, ctx *testcontext.Context, envVars []string, srcGlobs ...string) {
	...
	/* NB: Debugging c test binaries
	If you need to debug a c test binary with gdb, for example,
	you can assign an existing directory path to the
	STORJ_C_TEST_BIN_DIR env var. Each c test binary that is
	generated by this function will by copied to that directory
	after compilation.
	*/
