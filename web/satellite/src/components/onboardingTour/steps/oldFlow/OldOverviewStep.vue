...
<template>
    <div class="overview-area">
        <h2 class="overview-area__header">Welcome to Storj</h2>
...
export default class OldOverviewStep extends Vue {
     ...
     * Checks selection for analytics.
     */
    ...
    /**
     * Holds button click logic.
     * Checks selection for analytics and redirects to next step (creating access grant).
     */
    ...
    /**
     * Holds button click logic.
     * Checks selection for analytics and redirects to objects page.
     */
