    ...
    <div class="usage-report-container">
        ...
        <div class="usage-report-container__main-area">
            ...
            <div class="usage-report-container__main-area__footer">
                <p class="usage-report-container__main-area__footer__rollup-info">Current Roll Up Period <b>{{toLocaleDateString(startDate)}}</b> to <b>{{toLocaleDateString(endDate)}}</b></p>
