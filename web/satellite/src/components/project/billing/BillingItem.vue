    ...
    @Component({
		...
		computed: {
			billingPeriod: function(): string {
				...
				let endDate = (this as any).toLocaleDateString(new Date((this as any).invoice.endDate));

				return `${startDate} - ${endDate}`;
			},
			cardBrand: function () : string {
				return (this as any).invoice.paymentMethod.brand;
			},
