...
export default class EditProjectDetails extends Vue {
    ...
    public get paidBandwidthLimit(): number {
        if(this.activeBandwidthMeasurement == Dimensions.GB) {
            return this.toGB(this.getLimitValue(this.$store.state.appStateModule.defaultPaidBandwidthLimit));
        } else {
            return this.getLimitValue(this.$store.state.appStateModule.defaultPaidBandwidthLimit);
        }
    }

    public get paidStorageLimit(): number {
        if(this.activeStorageMeasurement == Dimensions.GB) {
            return this.toGB(this.getLimitValue(this.$store.state.appStateModule.defaultPaidStorageLimit));
        } else {
            return this.getLimitValue(this.$store.state.appStateModule.defaultPaidStorageLimit);
        }
    }
