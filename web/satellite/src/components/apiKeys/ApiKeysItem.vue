    ...
    <div class="apikey-item-container">
        <div class="apikey-item-container__common-info">
            <div class="checkbox-container">
                <svg class="checkbox-container__image" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="avatar">
                <svg class="avatar__image" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
