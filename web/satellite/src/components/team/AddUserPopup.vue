        ...
        <div class='add-user' id="addTeamMemberPopup">
            ...
            <div class="notification-wrap">
                ...
                <div class="notification-wrap__text">
                    <p>If the team member you want to invite to join the project is still not on this Satellite, please share this link to the signup page and ask them to register here: <a v-on:click="redirectToRegister">{{registerPath}}</a></p>
                </div>
            </div>
        </div>
    </div>
