...
<template>
    <div class="container">
        <svg :class="[(isActive && direction === SortingDirectionEnum.TOP) ? 'active' : '']"
        ...
        <svg :class="[(isActive && direction === SortingDirectionEnum.BOTTOM) ? 'active' : '']"
             width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script lang="ts">
    ...
    export default class VerticalArrows extends Vue {
        ...
        public SortingDirectionEnum = SortingDirectionEnum;
    }
</script>
