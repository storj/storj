...
export const APP_STATE_MUTATIONS = {
    ...
    TOGGLE_SELECT_PAYMENT_METHOD_POPUP: 'TOGGLE_SELECT_PAYMENT_METHOD_POPUP',
    TOGGLE_ATTACH_STRIPE_CARD_POPUP: 'TOGGLE_ATTACH_STRIPE_CARD_POPUP',
    TOGGLE_ADD_USER_PAYMENT_POPUP: 'TOGGLE_ADD_USER_PAYMENT_POPUP',
...
export const PROJECT_PAYMENT_METHODS_MUTATIONS = {
    FETCH: 'FETCH_PROJECT_PAYMENT_METHODS',
    CLEAR: 'CLEAR_PROJECT_PAYMENT_METHODS',
};

export const USER_PAYMENT_METHODS_MUTATIONS = {
    FETCH: 'FETCH_USER_PAYMENT_METHODS',
    ADD: 'ADD_USER_PAYMENT_METHOD',
    SET_DEFAULT: 'SET_DEFAULT_USER_PAYMENT_METHOD',
    CLEAR: 'CLEAR_USER_PAYMENT_METHODS'
};
