...
<template>
    <div class="info-area">
        ...
        <div v-if="isDisqualifiedInfoShown" class="info-area__disqualified-info">
            ...
            <p>Your node has been paused on <b>{{getDisqualificationDate}}</b>. If you have any questions regarding this please contact our <a href="https://support.storj.io/hc/en-us/requests/new">support</a>.</p>
        </div>
