...
<template>
    <div class="info-area">
        ...
        <div v-if="selectedSatellite.id && selectedSatellite.disqualified" class="info-area__disqualified-info">
            ...
            <p class="info-area__disqualified-info__info">Your node has been paused on <b>{{selectedSatellite.disqualified.toUTCString()}}</b>. If you have any questions regarding this please contact our <a href="https://support.storj.io/hc/en-us/requests/new">support</a>.</p>
        </div>
