...
<template>
    <div class="title">
        ...
        <div class="title__info">
            <svg class="check-svg" v-if="online" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg class="check-svg" v-else width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
