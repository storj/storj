...
func main() {
	...
	rootCmd.PersistentFlags().StringVarP(&flags.Postgres, "postgres", "", os.Getenv("STORJ_SIM_SATELLITEDB"), "connection string for postgres (defaults to STORJ_SIM_SATELLITEDB)")
