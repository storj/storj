...
var (
	...
	diagCfg struct {
		Database string `help:"the database connection string to use" default:"sqlite3://$CONFDIR/master.db"`
	}
	qdiagCfg struct {
...
func cmdDiag(cmd *cobra.Command, args []string) (err error) {
	...
	baRows, err := database.BandwidthAgreement().GetAllAgreements(context.Background())
	if err != nil {
