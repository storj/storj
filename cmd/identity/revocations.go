...
var (
	...
	revCfg struct {
		...
		RevocationDBURL string `default:"redis://$CONFDIR/revocations.db" help:"url for revocation database (e.g. bolt://some.db OR redis://127.0.0.1:6378?db=2&password=abc123)"`
	}
)
