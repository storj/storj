...
func (cache *overlaycache) UpdateCheckIn(ctx context.Context, node overlay.NodeCheckInInfo, config overlay.NodeSelectionConfig) (err error) {
	...
	query := `
			...
			VALUES (
				...
				$6, $7, $8, $9,
				$10::bool::int, 1,
				CASE WHEN $10::bool IS TRUE THEN current_timestamp
					ELSE '0001-01-01 00:00:00+00'
				END,
				CASE WHEN $10::bool IS FALSE THEN current_timestamp
					ELSE '0001-01-01 00:00:00+00'
				END,
				$11, $12, $13, $14,
				$18, $19, $20, $21, $22, $23
			...
			SET
				...
				uptime_reputation_alpha=$16::float*nodes.uptime_reputation_alpha + $17::float*$10::bool::float,
				uptime_reputation_beta=$16::float*nodes.uptime_reputation_beta + $17::float*(NOT $10)::bool::float,
				...
				disqualified = CASE WHEN (($16::float*nodes.uptime_reputation_alpha + $17::float*$10::bool::float) / (($16::float*nodes.uptime_reputation_alpha + $17::float*$10::bool::float) + ($16::float*nodes.uptime_reputation_beta + $17::float*(NOT $10)::bool::float))) <= $15 AND nodes.disqualified IS NULL
					THEN current_timestamp
