...
func StoragenodePaystub_SurgePercent(v int) StoragenodePaystub_SurgePercent_Field {
...
type StoragenodePaystub_Payed_Field struct {
	_set   bool
	_null  bool
	_value int64
}

func StoragenodePaystub_Payed(v int64) StoragenodePaystub_Payed_Field {
	return StoragenodePaystub_Payed_Field{_set: true, _value: v}
}

func (f StoragenodePaystub_Payed_Field) value() interface{} {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func (StoragenodePaystub_Payed_Field) _Column() string { return "payed" }
...
func (obj *postgresImpl) CreateNoReturn_StoragenodePaystub(ctx context.Context,
	...
	storagenode_paystub_payed StoragenodePaystub_Payed_Field) (
	err error) {
	defer mon.Task()(&ctx)(&err)
	...
	__payed_val := storagenode_paystub_payed.value()

	var __embed_stmt = __sqlbundle_Literal("INSERT INTO storagenode_paystubs ( period, node_id, created_at, codes, usage_at_rest, usage_get, usage_put, usage_get_repair, usage_put_repair, usage_get_audit, comp_at_rest, comp_get, comp_put, comp_get_repair, comp_put_repair, comp_get_audit, surge_percent, held, owed, disposed, payed ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )")

	var __values []interface{}
	__values = append(__values, __period_val, __node_id_val, __created_at_val, __codes_val, __usage_at_rest_val, __usage_get_val, __usage_put_val, __usage_get_repair_val, __usage_put_repair_val, __usage_get_audit_val, __comp_at_rest_val, __comp_get_val, __comp_put_val, __comp_get_repair_val, __comp_put_repair_val, __comp_get_audit_val, __surge_percent_val, __held_val, __owed_val, __disposed_val, __payed_val)
