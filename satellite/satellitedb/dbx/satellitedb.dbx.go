...
CREATE TABLE coupons (
	...
	remaining_mount bigint NOT NULL,
...
type Coupon_Update_Fields struct {
	RemainingMount Coupon_RemainingMount_Field
}
...
type Coupon_RemainingMount_Field struct {
	_set   bool
	_null  bool
	_value int64
}

func Coupon_RemainingMount(v int64) Coupon_RemainingMount_Field {
	return Coupon_RemainingMount_Field{_set: true, _value: v}
}

func (f Coupon_RemainingMount_Field) value() interface{} {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func (Coupon_RemainingMount_Field) _Column() string { return "remaining_mount" }
...
type Coupon_Start_Field struct {
	_set   bool
	_null  bool
	_value time.Time
}

func Coupon_Start(v time.Time) Coupon_Start_Field {
	return Coupon_Start_Field{_set: true, _value: v}
}

func (f Coupon_Start_Field) value() interface{} {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func (Coupon_Start_Field) _Column() string { return "start" }

type Coupon_End_Field struct {
	_set   bool
	_null  bool
	_value time.Time
}

func Coupon_End(v time.Time) Coupon_End_Field {
	return Coupon_End_Field{_set: true, _value: v}
}

func (f Coupon_End_Field) value() interface{} {
	if !f._set || f._null {
		return nil
	}
	return f._value
...
func (Coupon_End_Field) _Column() string { return "end" }
...
func (obj *postgresImpl) Create_Coupon(ctx context.Context,
	...
	coupon_remaining_mount Coupon_RemainingMount_Field,
	coupon_description Coupon_Description_Field,
	coupon_start Coupon_Start_Field,
	coupon_end Coupon_End_Field) (
	...
	__remaining_mount_val := coupon_remaining_mount.value()
	__description_val := coupon_description.value()
	__start_val := coupon_start.value()
	__end_val := coupon_end.value()
	__created_at_val := __now

	var __embed_stmt = __sqlbundle_Literal("INSERT INTO coupons ( id, user_id, amount, remaining_mount, description, start, end, created_at ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ? ) RETURNING coupons.id, coupons.user_id, coupons.amount, coupons.remaining_mount, coupons.description, coupons.start, coupons.end, coupons.created_at")

	var __stmt = __sqlbundle_Render(obj.dialect, __embed_stmt)
	obj.logStmt(__stmt, __id_val, __user_id_val, __amount_val, __remaining_mount_val, __description_val, __start_val, __end_val, __created_at_val)

	coupon = &Coupon{}
	err = obj.driver.QueryRow(__stmt, __id_val, __user_id_val, __amount_val, __remaining_mount_val, __description_val, __start_val, __end_val, __created_at_val).Scan(&coupon.Id, &coupon.UserId, &coupon.Amount, &coupon.RemainingMount, &coupon.Description, &coupon.Start, &coupon.End, &coupon.CreatedAt)
	if err != nil {
		return nil, obj.makeErr(err)
	}
	return coupon, nil
...
func (obj *postgresImpl) Get_Coupon_By_UserId(ctx context.Context,
	coupon_user_id Coupon_UserId_Field) (
	coupon *Coupon, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT coupons.id, coupons.user_id, coupons.amount, coupons.remaining_mount, coupons.description, coupons.start, coupons.end, coupons.created_at FROM coupons WHERE coupons.user_id = ? LIMIT 2")
	...
	coupon = &Coupon{}
	err = __rows.Scan(&coupon.Id, &coupon.UserId, &coupon.Amount, &coupon.RemainingMount, &coupon.Description, &coupon.Start, &coupon.End, &coupon.CreatedAt)
	if err != nil {
		return nil, obj.makeErr(err)
	}

	if __rows.Next() {
		return nil, tooManyRows("Coupon_By_UserId")
	}
...
func (obj *postgresImpl) Limited_Coupon_By_CreatedAt_LessOrEqual_OrderBy_Desc_CreatedAt(ctx context.Context,
	coupon_created_at_less_or_equal Coupon_CreatedAt_Field,
	limit int, offset int64) (
	rows []*Coupon, err error) {

	var __embed_stmt = __sqlbundle_Literal("SELECT coupons.id, coupons.user_id, coupons.amount, coupons.remaining_mount, coupons.description, coupons.start, coupons.end, coupons.created_at FROM coupons WHERE coupons.created_at <= ? ORDER BY coupons.created_at DESC LIMIT ? OFFSET ?")

	var __values []interface{}
	__values = append(__values, coupon_created_at_less_or_equal.value())
...
func (obj *postgresImpl) Update_Coupon_By_Id(ctx context.Context,
	...
	var __embed_stmt = __sqlbundle_Literals{Join: "", SQLs: []__sqlbundle_SQL{__sqlbundle_Literal("UPDATE coupons SET "), __sets, __sqlbundle_Literal(" WHERE coupons.id = ? RETURNING coupons.id, coupons.user_id, coupons.amount, coupons.remaining_mount, coupons.description, coupons.start, coupons.end, coupons.created_at")}}

	__sets_sql := __sqlbundle_Literals{Join: ", "}
	var __values []interface{}
	var __args []interface{}

	if update.RemainingMount._set {
		__values = append(__values, update.RemainingMount.value())
		__sets_sql.SQLs = append(__sets_sql.SQLs, __sqlbundle_Literal("remaining_mount = ?"))
	}
	...
	coupon = &Coupon{}
	err = obj.driver.QueryRow(__stmt, __values...).Scan(&coupon.Id, &coupon.UserId, &coupon.Amount, &coupon.RemainingMount, &coupon.Description, &coupon.Start, &coupon.End, &coupon.CreatedAt)
	if err == sql.ErrNoRows {
		return nil, nil
	}
	if err != nil {
...
func (rx *Rx) Create_Coupon(ctx context.Context,
	...
	return tx.Create_Coupon(ctx, coupon_id, coupon_user_id, coupon_amount, coupon_remaining_mount, coupon_description, coupon_start, coupon_end)
...
func (rx *Rx) Get_Coupon_By_UserId(ctx context.Context,
	coupon_user_id Coupon_UserId_Field) (
	coupon *Coupon, err error) {
	var tx *Tx
	if tx, err = rx.getTx(ctx); err != nil {
	...
	return tx.Get_Coupon_By_UserId(ctx, coupon_user_id)
}
...
func (rx *Rx) Limited_Coupon_By_CreatedAt_LessOrEqual_OrderBy_Desc_CreatedAt(ctx context.Context,
	coupon_created_at_less_or_equal Coupon_CreatedAt_Field,
	limit int, offset int64) (
	rows []*Coupon, err error) {
	var tx *Tx
	...
	return tx.Limited_Coupon_By_CreatedAt_LessOrEqual_OrderBy_Desc_CreatedAt(ctx, coupon_created_at_less_or_equal, limit, offset)
}
...
type Methods interface {
	...
	Get_Coupon_By_UserId(ctx context.Context,
		coupon_user_id Coupon_UserId_Field) (
		coupon *Coupon, err error)
	...
	Limited_Coupon_By_CreatedAt_LessOrEqual_OrderBy_Desc_CreatedAt(ctx context.Context,
		coupon_created_at_less_or_equal Coupon_CreatedAt_Field,
		limit int, offset int64) (
		rows []*Coupon, err error)
