...
func (rt *registrationTokens) CreateWithLimits(ctx context.Context, params console.CreateRegistrationTokenParams) (_ *console.RegistrationToken, err error) {
	defer mon.Task()(&ctx)(&err)
	...
	regToken, err := rt.db.Create_RegistrationToken(
		ctx,
		dbx.RegistrationToken_Secret(secret[:]),
		dbx.RegistrationToken_ProjectLimit(params.ProjectLimit),
		dbx.RegistrationToken_Create_Fields{
			StorageLimit:   dbx.RegistrationToken_StorageLimit_Raw(params.StorageLimit),
...
func registrationTokenFromDBX(regToken *dbx.RegistrationToken) (_ *console.RegistrationToken, err error) {
	...
	result := &console.RegistrationToken{
		...
		StorageLimit:   regToken.StorageLimit,
