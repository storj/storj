...
func TestProjectGet(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			link := "http://" + address.String() + "/legacy/api/projects/" + project.ID.String()
		...
		t.Run("Not Found", func(t *testing.T) {
			...
			link := "http://" + address.String() + "/legacy/api/projects/" + id.String() + "/limit"
			body := assertReq(
				ctx,
				t,
				link,
...
func TestProjectGetByAnyID(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		testGetProject := func(pid string) {
			link := "http://" + address.String() + "/legacy/api/projects/" + pid
			expected := fmt.Sprintf(
				`{"id":"%s","publicId":"%s","name":"%s","description":"%s","userAgent":null,"ownerId":"%s","maxBuckets":null,"createdAt":"%s","memberCount":0,"status":1,"storageLimit":"25.00 GB","bandwidthLimit":"25.00 GB","userSpecifiedStorageLimit":null,"userSpecifiedBandwidthLimit":null,"segmentLimit":10000,"rateLimit":null,"burstLimit":null,"defaultPlacement":0,"defaultVersioning":1,"isClassic":false}`,
				project.ID.String(),
				project.PublicID.String(),
...
func TestProjectLimitGet(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		linkLimit := "http://" + address.String() + "/legacy/api/projects/" + project.ID.String() + "/limit"
...
func TestProjectLimitUpdate(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("Update Not Found", func(t *testing.T) {
			...
			link := "http://" + address.String() + "/legacy/api/projects/" + id.String() + "/limit?usage=100000000"
			body := assertReq(
				ctx,
				t,
				link,
...
func TestProjectAdd(t *testing.T) {
	t.Run("Basic project creation", func(t *testing.T) {
		testplanet.Run(t, testplanet.Config{
			...
			req, err := http.NewRequestWithContext(ctx, http.MethodPost, "http://"+address.String()+"/legacy/api/projects", body)
			require.NoError(t, err)
	...
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			...
			req, err := http.NewRequestWithContext(
				ctx,
				http.MethodPatch,
				fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s/useragent", project.ID.String()),
				body,
			)
			require.NoError(t, err)
			req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
		...
		t.Run("Same UserAgent", func(t *testing.T) {
			...
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s/useragent", newProject.ID)
	...
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			...
			req, err := http.NewRequestWithContext(
				ctx,
				http.MethodPut,
				fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s", project.ID.String()),
				body,
			)
			require.NoError(t, err)
			req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
		...
		t.Run("Not Found", func(t *testing.T) {
			...
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s", id.String())
...
func TestProjectUpdateComputeAccessToken(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			url := fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s/compute-access-token", project.ID)
		...
		t.Run("Same AccessToken", func(t *testing.T) {
			...
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s/compute-access-token", project.ID)
...
func TestProjectDelete(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		req, err := http.NewRequestWithContext(
			ctx,
			http.MethodDelete,
			fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s", projectID),
			nil,
		)
		require.NoError(t, err)
		req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
...
func TestProjectCheckUsage_withoutUsage(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		req, err := http.NewRequestWithContext(
			ctx,
			http.MethodGet,
			fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s/usage", projectID),
			nil,
		)
		require.NoError(t, err)
		req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
...
func TestProjectCheckUsage_lastMonthUnappliedInvoice(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		req, err := http.NewRequestWithContext(
			ctx,
			http.MethodGet,
			fmt.Sprintf("http://"+address.String()+"/legacy/api/projects/%s/usage", project.ID),
			nil,
		)
		require.NoError(t, err)
		req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
