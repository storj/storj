...
func TestUserGet(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		link := "http://" + address.String() + "/legacy/api/users/" + project.Owner.Email
		expectedBody := `{` +
			fmt.Sprintf(
		...
		link = "http://" + address.String() + "/legacy/api/users/" + "user-not-exist@not-exist.test"
		body := assertReq(
			ctx,
			t,
			link,
...
func TestUserAdd(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		req, err := http.NewRequestWithContext(ctx, http.MethodPost, "http://"+address.String()+"/legacy/api/users", body)
		require.NoError(t, err)
...
func TestUserUpdate(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			// Update user data.
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s", user.Email)
			...
			link = "http://" + address.String() + "/legacy/api/users/alice+2@mail.test"
			newLimit := 50
			...
			now := time.Now()
			planet.Satellites[0].Admin.Admin.Server.SetLegacyNowFn(func() time.Time {
				return now
			})
			...
			for _, tt := range updateLimitsTests {
				...
				link = "http://" + address.String() + "/legacy/api/users/alice+2@mail.test/limits"
				...
				link2 := "http://" + address.String() + "/legacy/api/users/alice+2@mail.test/limits"
				expectedBody := `{` +
		...
		t.Run("Not found", func(t *testing.T) {
			link := "http://" + address.String() + "/legacy/api/users/user-not-exists@not-exists.test"
			body := `{"email":"alice+2@mail.test", "shortName":"Newbie"}`
		...
		t.Run("Email already used", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s", "alice+2@mail.test")
			body := `{"email":"alice+2@mail.test", "shortName":"Newbie"}`
...
func TestUserStatusUpdate(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/status/%d", user.Email, console.PendingDeletion)
		...
		t.Run("invalid value", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/status/not-int", user.Email)
		...
		t.Run("invalid status", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/status/%d", user.Email, console.UserStatus(100))
			responseBody := assertReq(ctx, t, link, http.MethodPut, "", http.StatusBadRequest, "", planet.Satellites[0].Config.Console.AuthToken)
...
func TestUserKindUpdate(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			...
			freezeUser := func() {
				link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/trial-expiration-freeze", user.Email)
				_ = assertReq(ctx, t, link, http.MethodPut, "", http.StatusOK, "", sat.Config.Console.AuthToken)
			...
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/kind/%d", memberUser.Email, console.MemberUser)
			_ = assertReq(ctx, t, link, http.MethodPut, "", http.StatusOK, "", sat.Config.Console.AuthToken)
		...
		t.Run("invalid value", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/kind/not-int", user.Email)
		...
		t.Run("invalid kind", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/kind/%d", user.Email, console.UserKind(100))
			responseBody := assertReq(ctx, t, link, http.MethodPut, "", http.StatusBadRequest, "", sat.Config.Console.AuthToken)
		...
		t.Run("failed to set Member kind for user with own projects", func(t *testing.T) {
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/kind/%d", user.Email, console.MemberUser)
...
func TestUpdateUsersUserAgent(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			...
			req, err := http.NewRequestWithContext(ctx, http.MethodPatch, fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/useragent", project.Owner.Email), body)
			require.NoError(t, err)
			req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
		...
		t.Run("Same UserAgent", func(t *testing.T) {
			...
			link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/useragent", project.Owner.Email)
...
func TestUpdateUsersExternalID(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		t.Run("OK", func(t *testing.T) {
			url := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/external-id", project.Owner.Email)
...
func TestDisableMFA(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/mfa", user.Email)
...
func TestUpdateTrialExpiration(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		req, err := http.NewRequestWithContext(ctx, http.MethodPatch, fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/trial-expiration", project.Owner.Email), body)
		require.NoError(t, err)
		req.Header.Set("Authorization", planet.Satellites[0].Config.Console.AuthToken)
...
func TestDisableBotRestriction(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/activate-account/disable-bot-restriction", user.Email)
...
func TestBillingFreezeUnfreezeUser(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/billing-freeze", userPreFreeze.Email)
...
func TestViolationFreezeUnfreezeUser(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		// freeze can be run multiple times. Test that doing so does not affect Unfreeze result.
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/violation-freeze", userPreFreeze.Email)
		body := assertReq(ctx, t, link, http.MethodPut, "", http.StatusOK, "", planet.Satellites[0].Config.Console.AuthToken)
		require.Len(t, body, 0)
...
func TestLegalFreezeUnfreezeUser(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		// freeze can be run multiple times. Test that doing so does not affect Unfreeze result.
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/legal-freeze", userPreFreeze.Email)
		body := assertReq(ctx, t, link, http.MethodPut, "", http.StatusOK, "", planet.Satellites[0].Config.Console.AuthToken)
		require.Len(t, body, 0)
...
func TestTrialExpirationFreezeUnfreezeUser(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		// freeze can be run multiple times. Test that doing so does not affect Unfreeze result.
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/trial-expiration-freeze", userPreFreeze.Email)
		body := assertReq(ctx, t, link, http.MethodPut, "", http.StatusOK, "", planet.Satellites[0].Config.Console.AuthToken)
		require.Len(t, body, 0)
...
func TestBillingWarnUnwarnUser(t *testing.T) {
	testplanet.Run(t, testplanet.Config{
		...
		link := fmt.Sprintf("http://"+address.String()+"/legacy/api/users/%s/billing-warning", user.Email)
		body := assertReq(ctx, t, link, http.MethodDelete, "", http.StatusOK, "", planet.Satellites[0].Config.Console.AuthToken)
		require.Len(t, body, 0)
