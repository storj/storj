    ...
    <v-card variant="flat" rounded="xlg" border>
        ...
        >
            ...
            <template #item.type="{ item }">
                <v-chip
                    :color="getColor(item.type)" variant="tonal" size="small" class="font-weight-bold"
            ...
            <template #item.status="{ item }">
                <v-chip
                    :color="getColor(item.status)" variant="tonal" size="small" class="font-weight-medium"
                    @click="setSearch(item.status)"
                >
                    {{ item.status }}
                </v-chip>
            </template>
            ...
            <template #item.placement="{ item }">
                <v-chip
                    ...
                    @click="setSearch(item.placement)"
                >
                    {{ item.placement }}
                </v-chip>
            </template>
