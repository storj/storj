	...
	{ // setup orders
		...
		peer.Orders.Service = orders.NewService(
			...
			&pb.NodeAddress{
				...
				Address:   config.Kademlia.ExternalAddress, // TODO KAD UPDATE
			},
...
func (peer *Peer) Local() overlay.NodeDossier { return peer.Kademlia.RoutingTable.Local() } // TODO KAD UPDATE
