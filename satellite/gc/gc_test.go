...
func TestGarbageCollection(t *testing.T) {
	testGCWithObservers(t, func(t *testing.T, makeObserver func(bloomfilter.Config, *testplanet.Planet) rangedloop.Observer) {
		testplanet.Run(t, testplanet.Config{
			...
			mbSegments := rangedloop.NewMetabaseRangeSplitter(zap.NewNop(), planet.Satellites[0].Metabase.DB, rangedloopConfig.AsOfSystemInterval, rangedloopConfig.SpannerStaleInterval, rangedloopConfig.BatchSize)
...
func TestGarbageCollectionWithCopies(t *testing.T) {
	testGCWithObservers(t, func(t *testing.T, makeObserver func(bloomfilter.Config, *testplanet.Planet) rangedloop.Observer) {
		testplanet.Run(t, testplanet.Config{
			...
			observer := makeObserver(config, planet)
			segments := rangedloop.NewMetabaseRangeSplitter(zap.NewNop(), planet.Satellites[0].Metabase.DB, rangedloopConfig.AsOfSystemInterval, rangedloopConfig.SpannerStaleInterval, rangedloopConfig.BatchSize)
...
func TestGarbageCollection_PendingObject(t *testing.T) {
	testGCWithObservers(t, func(t *testing.T, makeObserver func(bloomfilter.Config, *testplanet.Planet) rangedloop.Observer) {
		testplanet.Run(t, testplanet.Config{
			...
			observer := makeObserver(config, planet)
			rangedloopConfig := planet.Satellites[0].Config.RangedLoop
			provider := rangedloop.NewMetabaseRangeSplitter(zap.NewNop(), planet.Satellites[0].Metabase.DB, rangedloopConfig.AsOfSystemInterval, rangedloopConfig.SpannerStaleInterval, rangedloopConfig.BatchSize)
