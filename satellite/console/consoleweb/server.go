...
type Config struct {
	...
	DefaultPaidStorageLimit         memory.Size `help:"default paid-tier storage usage limit" default:"0 TB"`
	DefaultPaidBandwidthLimit       memory.Size `help:"default paid-tier bandwidth usage limit" default:"0 TB"`
