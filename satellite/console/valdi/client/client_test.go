...
func TestNewClient(t *testing.T) {
	t.Run("invalid url", func(t *testing.T) {
		c, err := client.NewClient(zaptest.NewLogger(t), http.DefaultClient, client.Config{
			APIBaseURL:   "://example",
			SignRequests: true,
		})
		require.Error(t, err)
		require.True(t, client.ErrAPIURL.Has(err))
	...
	t.Run("can't read key", func(t *testing.T) {
		...
		require.Error(t, err)
		require.True(t, client.ErrPrivateKey.Has(err))
...
func TestCreateUser(t *testing.T) {
	...
	createUser := client.UserCreationData{
