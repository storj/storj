...
type Config struct {
	...
	SuccessTrackerTrustedUplinks storj.NodeIDList      `help:"list of trusted uplinks for success tracker, deprecated. please use success-tracker-uplinks for uplinks that should get their own success tracker profiles and trusted-uplinks for uplinks that are trusted individually."`
	SuccessTrackerUplinks        storj.NodeIDList      `help:"list of uplinks for success tracker"`
	FailureTrackerChanceToSkip   float64               `help:"the chance to skip a failure tracker generation bump" default:".6"`
	TrustedUplinks               storj.NodeIDList      `help:"list of trusted uplinks"`
