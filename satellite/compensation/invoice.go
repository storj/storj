...
type Invoice struct {
	...
	VoluntaryDiscount  currency.MicroUnit `csv:"voluntary-discount,optional"` // Gross pre-surge, pre-withholding amount discounted by the node's self-signed price tags (not the actual reduction in owed)
}
