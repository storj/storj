...
type Config struct {
	...
	EscrowPercents Percents `user:"true" help:"comma separated monthly escrow percentage rates" default:"75,75,75,50,50,50,25,25,25,0,0,0,0,0,0"`
	DisposePercent int      `user:"true" help:"percent of held amount disposed to node after leaving escrow" default:"50"`
}
