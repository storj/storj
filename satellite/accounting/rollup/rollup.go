...
type Config struct {
	...
	DefaultMaxUsage     memory.Size   `help:"the default storage usage limit" releaseDefault:"5GB" devDefault:"200GB"`
	DefaultMaxBandwidth memory.Size   `help:"the default bandwidth usage limit" releaseDefault:"5GB" devDefault:"200GB"`
